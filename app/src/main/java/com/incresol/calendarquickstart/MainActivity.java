    ...
    private class MakeRequestTask extends AsyncTask<Void, Void, ArrayList<String>> {
        ...
        private ArrayList<String> getDataFromApi() throws IOException {
            ...
            for (int i = 0; i < items.size(); i++) {
                ...
                eventStrings.add(
                        String.format("(%d). %s (%s - %s)", i+1,event.getSummary(),new SimpleDateFormat("dd-MM-yyyy HH:mm").format(start.getValue()) , new SimpleDateFormat("dd-MM-yyyy HH:mm").format(end.getValue())));
            }
